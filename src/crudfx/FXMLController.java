...
public class FXMLController implements Initializable {
    ...
    @FXML private int codigo;
    
    @FXML private Cliente c;
    
    @FXML private final ClienteDAO dao = new ClienteDAO();
    
    @FXML private String nome;
    ...
    @FXML private TableColumn<Cliente, String> colNasc;
